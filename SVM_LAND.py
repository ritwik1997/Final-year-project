import matplotlib.pyplot as plt
    ...
    #X_MDS = manifold.MDS(n_components=1000).fit_transform(X)
    #X_LLE = manifold.LocallyLinearEmbedding(n_components=1000).fit_transform(X)
    #X_tSNE = manifold.TSNE(n_components=2500).fit_transform(X)
    X_SpectralEmbedding = manifold.SpectralEmbedding(n_components=1250).fit_transform(X)
    start=time.time()
